...
public class CameraController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        // The position we're about to move to can't go beyond that.
        ...
        // Set the camera position to that location.
    ...
    private IEnumerator ShakeCoroutine(float intensity, float duration)
    {
        ...
        while(elapsed < duration)
        {
            ...
            //shakeOffset = Random.insideUnitCircle * intensity; // Returns a random point within a circle
